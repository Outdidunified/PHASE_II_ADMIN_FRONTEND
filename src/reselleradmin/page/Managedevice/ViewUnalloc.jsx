...
const ViewUnalloc = ({ userInfo, handleLogout }) => {
    ...
    useEffect(() => {
        ...
        if (charger) {
            setNewDevice({
                charger_id: charger.charger_id || '', model: charger.model || '', type: charger.type || '',
                gun_connector: charger.gun_connector || '', max_current: charger.max_current || '', created_date: charger.created_date || '',
                status: charger.status || '', tag_id: charger.tag_id || '', assigned_association_date: charger.assigned_association_date || '',
